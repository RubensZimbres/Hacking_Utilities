...
Description:  
This Python (3) file reads a password list from a text file and generates dozens of different samples for each given word, adding numbers instead of letters, adding special characters and reverting the password.  
